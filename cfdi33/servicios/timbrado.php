...
function actualizarSello($archivoXml)
{
    ...
    $xslt->load('../cadena_original/cadenaoriginal_3_3.xslt');
    $xml = new DOMDocument;
    $xml->load($archivoXml);
...
$wsdl_usuario    = '';
$wsdl_contrasena = '';
$ruta_xml        = '../xml_ejemplos/ejemplo_cfdi_33.xml';
